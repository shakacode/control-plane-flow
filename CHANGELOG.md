...
- **Fixed direct Control Plane API retries so HTTP 429 responses retry every request method and honor `Retry-After`, while 5xx retries remain limited to idempotent methods.** Fixes [issue 417](https://github.com/shakacode/control-plane-flow/issues/417).
